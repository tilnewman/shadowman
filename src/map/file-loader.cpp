...
namespace shadowman
{
    ...
    /*
    void FileLoader::parseTilesetAsSeparateFile(
        ...
        std::string & t_transparentColorStrOutParam)
    {
        ...
        if (t_tileImageOutParam == TileImage::Count)
        {
            std::cout << "FileLoader::parseTilesetAsSeparateFile()  While parsing \"" << m_pathStr
                      << "\": Found a tileset (gid=" << t_gid
    ...
    */
    ...
    void FileLoader::parseTransitionsLayer(const Context &, const nlohmann::json &)
    {
